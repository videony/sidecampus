...
/**
 * Description of BloqueSessionModel
 *
 * @author videony
 */
class BloqueSessionModel {
    private $pid;
    // Filtres
    const AND_MODE = 'AND';
    const OR_MODE= 'OR';
    ...
    public function create($heure_fin, $tx_color, $heure_debut, $jour_semaine, $tx_sujet, $id_semaine_bloque) {
        $query = "INSERT INTO seance_bloque(heure_fin, tx_color, heure_debut, jour_semaine, tx_sujet, id_semaine_bloque)"
                . " VALUES(:heure_fin, :tx_color, :heure_debut, :jour_semaine, :tx_sujet, :id_semaine_bloque)";
...
':tx_sujet' => $tx_sujet, 
':id_semaine_bloque' => $id_semaine_bloque
        ));
    ...
    public function get() {
        ...
        {
            $query = "SELECT * FROM seance_bloque WHERE id_seance_bloque = :id";
    ...
    public function set($modifications) {
        ...
        {
            $query = 'UPDATE seance_bloque SET ';
            $first = TRUE;
            $vals = array();
            ...
            $query .= ' WHERE id_seance_bloque = :id';
            $vals[':id'] = $this->pid;
    ...
    public function remove()
    {
        ...
        {
            $query = "DELETE FROM seance_bloque WHERE id_seance_bloque = :id";
    ...
    {
        $query = "DELETE FROM seance_bloque WHERE ";
        $first = TRUE;
        $vals = array();
     ...
     */
    public function getBloqueSessionByFilter($filters, $mode = self::AND_MODE, $equality = self::EQUAl)
    {
        $query = "SELECT * FROM seance_bloque WHERE ";
        $first = TRUE;
        $vals = array();
        foreach($filters as $col=>$val)
        {
        ...
        $query .= ' ORDER BY heure_debut DESC';
     ...
     * @return array Resultset de la requête
     */
    public function getAllBloqueSessions()
    {
        $query = 'SELECT * FROM seance_bloque ORDER BY heure_debut DESC';
